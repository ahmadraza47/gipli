        ...
        def _compute_base_line_taxes(base_line):
            ...
            if move.is_invoice(include_receipts=True):
                ...
                if base_line.currency_id:
                    price_unit_foreign_curr = sign * base_line.sh_retail_price * (1 - (base_line.discount / 100.0))
                    ...
                    price_unit_comp_curr = sign * base_line.sh_retail_price * (1 - (base_line.discount / 100.0))
            else:
                quantity = 1.0
